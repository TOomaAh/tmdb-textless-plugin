...
namespace Jellyfin.Plugin.TextlessImages.Tmdb.Configuration
{
    /// <summary>
    ...
    public class PluginConfiguration : BasePluginConfiguration
    {
        ...
        /// <summary>
        /// Gets or sets a value indicating whether images without text should be excluded from the import.
        /// </summary>
        public bool ExcludeTextLessImages { get; set; }
