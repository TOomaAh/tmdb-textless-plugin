...
namespace Jellyfin.Plugin.TextlessImages.Tmdb.BoxSets
{
    /// <summary>
    ...
    public class TmdbBoxSetProvider : IRemoteMetadataProvider<BoxSet, BoxSetInfo>
    {
        ...
        public TmdbBoxSetProvider(IHttpClientFactory httpClientFactory, TextlessClientManager tmdbClientManager, ILibraryManager libraryManager)
        {
