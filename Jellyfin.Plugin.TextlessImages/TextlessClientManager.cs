...
namespace Jellyfin.Plugin.TextlessImages.Tmdb
{
    /// <summary>
    /// Manager class for abstracting the TMDb API client library.
    /// </summary>
    public class TextlessClientManager : IDisposable
    {
        private const int CacheDurationInHours = 1;
        private readonly ILogger<TextlessClientManager> _logger;

        private readonly IMemoryCache _memoryCache;
        private readonly TMDbClient _tmDbClient;

        /// <summary>
        /// Initializes a new instance of the <see cref="TextlessClientManager"/> class.
        /// </summary>
        /// <param name="memoryCache">An instance of <see cref="IMemoryCache"/>.</param>
        /// <param name="logger">An instance of <see cref="ILogger{TextlessClientManager}"/>.</param>
        public TextlessClientManager(IMemoryCache memoryCache, ILogger<TextlessClientManager> logger)
        {
            logger.LogInformation("Initializing TMDb client manager");
            ...
            logger.LogWarning("TMDb API key: {ApiKey}", apiKey);
            _logger = logger;
        }
